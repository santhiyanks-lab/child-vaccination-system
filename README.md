...
💉
Integrated Digital Platform for Child Vaccination, Scheduling, Monitoring & Reporting
...
Book Appointment
Child-Ananya R. (ID: C-004)
Vaccine Due-DPT Dose 2
Select Hospital-City Health Centre, Erode
Date-2025-03-26
Time-10:30 AM
📅 Confirm Appointment
Database Schema
...
email-VARCHAR(50)
state / district-VARCHAR(50)
username / password-VARCHAR(50)
status-ENUM
...
due_days-VARCHAR(20) ⭐
interval_days-VARCHAR(20) ⭐
min / max age-INT / VARCHAR
status-ENUM(confirmed/deleted)

appointment-9 fields — joins all 4 tables above
appo_id-INT PK
child_id-INT FK
vaccine_id-INT FK
parent_id-INT FK
...
7.)Dose Administration & Completion
...
🔗 Integration ABDM / Health ID Link
